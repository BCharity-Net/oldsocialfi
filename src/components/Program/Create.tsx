...
const Create: React.FC = () => {
  ...
  const createProgram = async (name: string, description: string | null) => {
    if (!account?.address) {
    ...
    <GridLayout>
      <GridItemFour>
        <SettingsHelper
          ...
          description="Create new decentralized program"
        />
      </GridItemFour>
      <GridItemEight>
        <Card>
          <CardBody>
            {data?.hash ? (
              ...
              >
                ...
                <TextArea
                  label="Description"
                  placeholder="Tell us something about the program!"
